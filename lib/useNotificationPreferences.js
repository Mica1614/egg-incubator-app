 ...
 *
 * Routine actuator on/off events default to OFF. In auto mode the heater and
 * humidifier cycle every few minutes, and notifying on each transition was the
 * single largest source of the notification flood the client reported. Users who
 * want them can switch them back on per device; anyone who already saved a
 * preference keeps whatever they chose, since saved values are merged over these.
 */
const DEFAULT_PREFERENCES = {
  [NOTIFICATION_TYPES.WATER_LOW]: true,
  [NOTIFICATION_TYPES.WATER_OK]: true,
  [NOTIFICATION_TYPES.HEATER_ON]: false,
  [NOTIFICATION_TYPES.HEATER_OFF]: false,
  [NOTIFICATION_TYPES.EGG_TURNER_ON]: false,
  [NOTIFICATION_TYPES.EGG_TURNER_OFF]: false,
  [NOTIFICATION_TYPES.FAN_ON]: false,
  [NOTIFICATION_TYPES.FAN_OFF]: false,
  [NOTIFICATION_TYPES.HUMIDIFIER_ON]: false,
  [NOTIFICATION_TYPES.HUMIDIFIER_OFF]: false,
